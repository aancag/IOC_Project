...
public class AddCarpool3 extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_add_carpool3);
	}
	...
	public void finishAddCarpool(View view) {
		...
		TextView notAllFieldsCompleted = (TextView) findViewById(R.id.notAllFieldsCompletedAC3);
	...
	class AddCarpoolInDB extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			progressMessage = new ProgressDialog(AddCarpool3.this);
